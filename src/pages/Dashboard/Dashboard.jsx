...
const Dashboard = () => {
  ...
  const MyStats = async () => {
    try {
      ...
      const investments =
        parseFloat(response.data.data.totalSavings) +
        parseFloat(response.data.data.totalInterest);
      //   totalSavings
    ...
    <div className='flex bg-slate-50 pb-20'>
      ...
      <div className='mt-6 px-6'>
        ...
        <div className='w-full relative mt-3'>
          <div
            className='flex flex-row flex-wrap p-5 md:p-12 justify-evenly rounded-lg w-full centered text-white'
            style={{
          ...
          >
            <div>
              <p className='text-[#FAFAFA] pb-2  text-[14px] font-[400px] leading-5'>
                Available Balance
              </p>
              <p className='text-[#FFFFFF] text-[20px] font-[700px] leading-10'>
                ₦{availableBalance ? availableBalance : '00.00'}
              </p>
            </div>
            <div>
              <p className='text-[#FAFAFA] pb-2 text-[14px] font-[400px] leading-5'>
              ...
              <p className='text-[#FFFFFF] text-[20px] font-[700px] leading-10'>
                ₦{impactInvestments ? impactInvestments : '00.00'}
              </p>
            </div>
            <div>
              <p className='text-[#FAFAFA] pb-2 text-[14px] font-[400px] leading-5'>
              ...
              <p className='text-[#FFFFFF] text-[20px] font-[700px] leading-10'>
                ₦{totalSavings ? totalSavings : '00.00'}
              </p>
            </div>
            <div>
              <p className='text-[#FAFAFA] pb-2 text-[14px] font-[400px] leading-5'>
              ...
              <p className='text-[#FFFFFF] text-[20px] font-[700px] leading-10'>
                ₦{totalReturns ? totalReturns : '00.00'}
              </p>
            </div>
          </div>
        </div>
        ...
        <div>
          <h1
            className='font-bold text-[#B4B5C1]'
            style={{
              fontFamily: 'Satoshi',
              fontWeight: '700px',
              fontSize: '16px',
        ...
        {Plans.length === 0 ? (
          ...
          <div className='grid grid-cols-1 lg:grid-cols-3 gap-4'>
            {Plans.map((Plan, i) => (
              <div
                key={Plan.id}
                className='grid grid-rows-2 gap-4 p-6 bg-white rounded-lg border border-gray-200 shadow-md '
              >
                <div className='flex flex-row space-x-4'>
                  ...
                  <span>
                    <h2 className='text-sm pt-2 text-[16px] font-[400px] leading-6'>
                      {Plan.name}
                    </h2>
                  </span>
                </div>
                ...
                <div>
                  <h2 className='BoldFonter pb-2 text-[24px] font-[700px] leading-8'>
                    {Plan.amount}
                  </h2>

                  <div className='w-full bg-gray-300 h-1'>
                    <div
                      className='bg-[#265859] h-1'
                      style={{ width: '45%' }}
                    ></div>
                  </div>
                </div>
        ...
        <div className='grid grid-cols-1 lg:grid-cols-3 gap-4'>
          <div
            className='grid grid-rows-2 gap-4 p-6 h-48 max-w-sm rounded-lg border border-gray-200 shadow-md bg-[#5B2E4F] text-white'
            style={{
          ...
          >
            <Link to='/CreatePlan'>
              <div className=''>
                <h2 className='BoldFonter text-[16px] font-[700px] leading-5 pb-2'>
                  {' '}
                  Create a savings plan{' '}
                </h2>
                <p className='text-[10px] font-[400px] leading-3'>
                  {' '}
                  Earn up to 12%{' '}
                </p>
              </div>
          ...
          <div
            className='grid grid-rows-2 gap-4 p-6 h-48 max-w-sm rounded-lg border border-gray-200 shadow-md bg-[#F2F1F3]'
            style={{
          ...
          >
            <div className=''>
              <h2 className='text-[#5B2E4F] BoldFonter text-[16px] font-[700px] leading-5'>
                {' '}
                Invite your girls to{' '}
              </h2>
              <h2 className='text-[#5B2E4F] BoldFonter text-[16px] font-[700px] leading-5 pb-2'>
                HerVest{' '}
              </h2>
              <p className='text-xs pb-2 text-[10px] font-[400px] leading-'>
                {' '}
                Share your girl code
              </p>
            </div>
            <div className='mt-5 flex flex-row space-x-4'>
              <div
                to=''
                className='inline-flex items-center text-[16px] font-[700px] leading-5 py-1 px-3 BoldFonter text-center text-white bg-[#5B2E4F] rounded-lg '
              >
                {referralCode}
              </div>
              <div>
