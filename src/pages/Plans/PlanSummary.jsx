    ...
    <div className='flex min-h-screen bg-slate-50 pb-20'>
      ...
      <div>
        ...
        <div className='mx-8 mb-8'>
          <span className='text-[#B4B5C1] text-[14px] font-[400px] leading-5 '>
          ...
          <span className='ml-2'>
            ...
            >
              <path
                d='M8.66602 11.424L11.9993 8.09066L8.66602 4.75732'
                stroke='#5B2E4F'
                strokeLinecap='round'
                strokeLinejoin='round'
              />
              <path
                d='M4 11.424L7.33333 8.09066L4 4.75732'
                stroke='#5B2E4F'
                strokeLinecap='round'
                strokeLinejoin='round'
              />
          ...
          <span className='text-[#5B2E4F] text-[14px] font-[400px] leading-5 ml-2'>
        ...
        <div className='bg-white rounded-2xl m-8 px-12 py-8'>
          <div className='pb-8'>
            <Link to='/CreatePlan'>
              ...
              >
                ...
                />
                <path
                  d='M10.2988 18.2985L4.24883 12.2745L10.2988 6.24951'
                  stroke='#626375'
                  strokeWidth='1.5'
                  strokeLinecap='round'
                  strokeLinejoin='round'
              ...
              <span className='text-[16px] font-[300px] leading-6 text-[#626375]'>
                Back
              </span>
            </Link>
          </div>
          ...
          <div className='grid sm:grid-rows-1 sm:gap-4 md:grid-cols-2 md:gap-2 '>
            <div>
              <p className='text-[32px] font-[700px] leading-10 BoldFonter'>
                Here’s a summary
              </p>
              <p className='text-[16px] font-[300px] leading-6 text-[#7C7F93] pt-4'>
                Before you go, here’s a summary of your savings plan.
              </p>
            </div>

            <div
              className='rounded-2xl border-2 border-gray-300 p-4  mb-8'
              style={{ width: '' }}
            >
              <div className='mb-8'>
                <p className='text-[#666666] text-[16px] font-[400px] leading-5 pb-2'>
                  Plan name
                </p>
                <p className='text-[20px] font-[400px] leading-6 BoldFonter'>
                  {planName}
                </p>
              </div>
              <hr />
              ...
              <div className='grid grid-cols-2 gap-x-20 gap-y-4 mb-8 mt-8'>
                <div>
                  <p className='text-[#666666] pb-2  text-[14px] font-[300px] leading-5'>
                    Target amount
                  </p>
