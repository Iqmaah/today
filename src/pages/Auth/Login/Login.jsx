      ...
      <div className='border border-white-100 rounded-2xl bg-white my-6 mx-8 flex justify-center items-center py-6'>
        <div className='py-8 px-12 rounded-2xl max-w-md w-full space-y-8'>
          <div className=' flex flex-row justify-end mb-6 absolute top-4 right-12'>
            <p className='text-gray-400 text-[16px] font-[300px] leading-5'>
              New user?
            </p>
            &nbsp;
            <p className='text-[#5B2E4F] BoldFonter text-[16px] font-[300px] leading-5'>
          ...
          <div className=''>
            <h1 className='BoldFonter text-[32px] text-[#5B2E4F] font-[700px] leading-10 mb-2'>
              {' '}
              Welcome!{' '}
            </h1>
            <p className='text-gray-500 text-[16px] font-[400px] leading-6'>
          ...
          <form onSubmit={handleOnSubmit}>
            <div className='mb-2'>
              <label
                htmlFor='email'
                className='text-[13px] font-[500px] leading-5'
              >
                Email{' '}
              </label>
            ...
            <div className='flex justify-end mt-2'>
              <p className='mb-14 text-[14px] font-[400px] leading-4'>
                Forgot password?{' '}
                <Link
                  to='/PasswordReset1'
                  className='text-[#5B2E4F] BoldFonter'
                >
                  Reset it here
                </Link>
              </p>
          ...
          <div className='flex items-center py-2'>
            ...
            {/* <!-- Your text here --> */}
            <span className='flex-shrink px-4 text-[13px] font-[500px] leading-5 MediumFonter'>
              or log in with
            </span>
